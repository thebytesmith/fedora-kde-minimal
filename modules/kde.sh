module_kde() {
    ...
    local essential_plasma=(kwrite kate gwenview spectacle ark unrar tar zip 7zip sddm sddm-kcm sddm-breeze bluez kinfocenter okular qrca kde-partitionmanager filelight kcalc)
